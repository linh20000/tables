        ...
        !(function (r, s) {
                ...
                return (
                    ...
                    (o.getPositionValue = function (t) {
                        return this.options.percentPosition
                            ? 0.01 *
                                  Math.round((t / this.size.innerWidth) * 1e4) +
                                  "%"
                            : Math.round(t) + "px";
                    }),
                    (o.settle = function (t) {
            ...
            (function (t, i) {
                ...
                function l(t, e) {
                    ...
                    if (!i)
                        return void (
                            d &&
                            d.error("Bad element for Flickity: " + (i || t))
                        );
                    ...
                    (f.activate = function () {
                        if (!this.isActive) {
                            (this.isActive = !0),
                                ...
                                this.getSize();
                            var t = this._filterFindCellElements(
                ...
                return (
                    ...
                    (f._getWrapShiftCells = function () {
                        if (this.options.wrapAround) {
                            ...
                            (this.beforeShiftCells = this._getGapCells(
                                ...
                                (t =
                                    this.size.innerWidth - this.cursorPosition),
                                (this.afterShiftCells = this._getGapCells(
                                    t,
                                    0,
                                    1
                                ));
                    ...
                    (f.dispatchEvent = function (t, e, i) {
                        ...
                        if ((this.emitEvent(t, n), c && this.$element)) {
                            t += this.options.namespaceJQueryEvents
                                ? ".flickity"
                                : "";
                            var o = t;
                            if (e) {
                    ...
                    (f.destroy = function () {
                        this.deactivate(),
                            ...
                            c &&
                                this.$element &&
                                c.removeData(this.element, "flickity"),
             ...
             */ (function (t, i) {
                ...
                (o.bindStartEvent = function (t) {
                    ...
                    (o.onMSPointerDown = o.onpointerdown =
                        function (t) {
                ...
                return (
                    ...
                    (o.onMSPointerMove = o.onpointermove =
                        function (t) {
                    ...
                    (o.pointerDone = i),
                    (o.onMSPointerCancel = o.onpointercancel =
                        function (t) {
                            t.pointerId == this.pointerIdentifier &&
            ...
            (function (t, i) {
                ...
                (o.prototype = new i()),
                    ...
                    (o.prototype.addDots = function (t) {
                        for (
                            var e = document.createDocumentFragment(), i = [];
                            t;
            ...
            (function (t, i) {
                ...
                return (
                    ...
                    (o.remove = function (t) {
                        ...
                        for (e = 0; e < s; e++)
                            (n = o[e]), n.remove(), i.removeFrom(this.cells, n);
            ...
            (function (t, i) {
                ...
                function n(t) {
                    if (
                        "IMG" == t.nodeName &&
                        t.getAttribute("data-flickity-lazyload")
                    )
                        return [t];
             ...
             */ (function (t, i) {
                (n = [p, g, y, w, b, x, C]),
                    (r = i),
                    !(S = "function" == typeof r ? r.apply(e, n) : r);
            })(window, function (t) {
                return t;
            }),
            /*!
                    ...
                    (n.navCompanionSelect = function (t) {
                        if (this.navCompanion) {
                            var e = this.navCompanion.selectedCells[0],
                                ...
                                o =
                                    n +
                                    this.navCompanion.selectedCells.length -
                                    1,
                                r = Math.floor(
                                    i(n, o, this.navCompanion.cellAlign)
                                );
                            if (
                ...
                (window.Hammer.time = {
                    ...
                    shouldHammer: function (t) {
                        ...
                        return (
                            !(
                                !e ||
                                (s && !(Date.now() - t.target.lastStart < 125))
                            ) && e
                        );
                    },
                    ...
                    styleUpdater: function (t) {
                        ...
                        return e
                            ...
                            : void (
                                  !e &&
                                  ((t.oldValue &&
                                      this.checkStyleString(t.oldValue)) ||
            ...
            (w.prototype = {
                ...
                _close: function () {
                    ...
                    n.off("keyup" + m + " focusin" + m),
                        ...
                        !e.st.showCloseBtn ||
                            (e.st.closeBtnInside &&
                                e.currTemplate[e.currItem.type] !== !0) ||
                            (e.currTemplate.closeBtn &&
                            ...
                            if (r.length) {
                                ...
                                s &&
                                    ...
                                    (T ||
                                        ...
                                        (T = S(A)),
                                        (A = "mfp-" + A)),
                                    (_ = r.after(T).detach().removeClass(A))),
                ...
                proto: {
                    initImage: function () {
                        ...
                        e.types.push("image"),
                            ...
                            C(a + n, function () {
                                i.cursor &&
                                    t(document.body).removeClass(i.cursor),
                                    x.off("resize" + m);
                            }),
                    ...
                    getImage: function (i, n) {
                        ...
                        return (
                            e._parseMarkup(
                                n,
                                { title: O(i), img_replaceWith: i.img },
                                i
                            ),
                            e.resizeImage(),
                            i.hasSize
                ...
                proto: {
                    ...
                    _getOffset: function (i) {
                        ...
                        var a = {
                            width: n.width(),
                            height:
                                (b ? n.innerHeight() : n[0].offsetHeight) -
                                s -
                                r,
                        };
                        return (
                ...
                proto: {
                    initRetina: function () {
                        if (window.devicePixelRatio > 1) {
                            ...
                            (i = isNaN(i) ? i() : i),
                                i > 1 &&
                                    (C("ImageHasSize." + q, function (t, e) {
                                        e.img.css({
                                            "max-width":
                                                e.img[0].naturalWidth / i,
                                            width: "100%",
                                        });
                                    }),
	...
	*/
                    ...
                    (i.prototype.flushTriggers = function () {
                        for (var i in this.triggerQueues) {
                            ...
                            for (var r = 0, s = n.length; r < s; r += 1) {
                                var a = n[r];
                                (a.options.continuous || r === n.length - 1) &&
                                    a.trigger([i]);
                            }
                        }
                        this.clearTriggerQueues();
        ...
        function n(t, e) {
            if (!t[a].parsingSrcset) {
                ...
                if (e) r = e;
                    ...
                    (t[a].parsingSrcset = !0),
                        (t[s.ns] && t[s.ns].evaled) ||
                            s.fillImg(t, { reselect: !0 }),
                        t[s.ns].curSrc ||
                            ((t[s.ns].supported = !1),
                            s.fillImg(t, { reselect: !0 })),
                        delete t[a].parsingSrcset,
                        (r = t[s.ns].curSrc || r);
                }
                ...
                (t.style.backgroundImage = 'url("' + r + '")'),
                    ...
                    /scale-down/.test(n["object-fit"])
                        ? (t[a].i || ((t[a].i = new Image()), (t[a].i.src = r)),
                          (function e() {
                              return t[a].i.naturalWidth
                                  ? void (t[a].i.naturalWidth > t.width ||
                                    t[a].i.naturalHeight > t.height
        ...
        function r() {
            d ||
                ((HTMLImageElement.prototype.getAttribute = function (t) {
                    return !this[a] || ("src" !== t && "srcset" !== t)
                        ? p.call(this, t)
                        : this[a][t + "Attr"];
                }),
                (HTMLImageElement.prototype.setAttribute = function (t, e) {
                    !this[a] || ("src" !== t && "srcset" !== t)
                        ? f.call(this, t, e)
                ...
                (document.body.addEventListener(
                    ...
                    function (t) {
                        "IMG" === t.target.tagName &&
                            s(t.target, { skipTest: e.skipTest });
                    },
                    !0
                ),
                (m = !0),
        ...
        !(function (t, e, i) {
            function n(e, i) {
                this.bodyOverflowX,
                    ...
                    (this.namespace =
                        "tooltipster-" + Math.round(1e5 * Math.random())),
                    (this.Status = "hidden"),
                    (this.timerHide = null),
                    (this.timerShow = null),
                    this.$tooltip,
            ...
            (n.prototype = {
                    ...
                    if (i.querySelector) {
                        ...
                        void 0 === e.$el.data("tooltipster-initialTitle") &&
                            ...
                            null !== e.options.content
                                ...
                                : e._content_set(n);
                        var o = e.options.functionInit.call(
                            e.$el,
                            e.$el,
                            e.Content
                        );
                        "undefined" != typeof o && e._content_set(o),
                            ...
                            (!c && e.options.iconDesktop) ||
                            (c && e.options.iconTouch)
                            ...
                            "hover" == e.options.trigger
                                ? (e.$elProxy
                                      .on(
                                          "mouseenter." + e.namespace,
                                          function () {
                                              (r() &&
                                                  !e.options.touchDevices) ||
                                                  ((e.mouseIsOverProxy = !0),
                                                  e._show());
                                          }
                                      )
                                      .on(
                                          "mouseleave." + e.namespace,
                                          function () {
                                              (r() &&
                                                  !e.options.touchDevices) ||
                            ...
                            if ("hidden" !== n.Status) {
                                ...
                                var a = "tooltipster-" + n.options.animation,
                                    ...
                                    u = n.options.minWidth
                                        ? "min-width:" +
                                          Math.round(n.options.minWidth) +
                                          "px;"
                                        : "",
                                    d = n.options.maxWidth
                                        ? "max-width:" +
                                          Math.round(n.options.maxWidth) +
                                          "px;"
                                        : "",
                                    h = n.options.interactive
                                        ? "pointer-events: auto;"
                                        : "";
                                if (
                                    ((n.$tooltip = t(
                ...
                _interval_set: function () {
                    ...
                    e.checkInterval = setInterval(function () {
                        if (
                            ...
                            ("shown" != e.Status && "appearing" != e.Status) ||
                                e.hide(),
                                e._interval_cancel();
                            ...
                            o(i.dimension, e.elProxyPosition.dimension) &&
                                ("fixed" === e.$elProxy.css("position")
                                    ? o(
                                          i.position,
                                          e.elProxyPosition.position
                                      ) && (n = !0)
                                    : o(i.offset, e.elProxyPosition.offset) &&
                                      (n = !0)),
                                n ||
                                    (e.reposition(),
                                    e.options.positionTrackerCallback.call(
                                        e,
                                        e.$el
                                    ));
                        }
                ...
                reposition: function () {
                    ...
                    function n(i, n) {
                        a.offset.top - t(e).scrollTop() - c - I - 12 < 0 &&
                            n.indexOf("top") > -1 &&
                            (M = i),
                            a.offset.top + a.dimension.height + c + 12 + I >
                                t(e).scrollTop() + t(e).height() &&
                                n.indexOf("bottom") > -1 &&
                                ((M = i), (_ = a.offset.top - c - I - 12));
                    }
                    var o = this;
                    if (0 !== t("body").find(o.$tooltip).length) {
                        ...
                        if (o.$elProxy.is("area")) {
                            ...
                            if ("circle" == u) {
                                ...
                                var g = parseInt(m[0]),
                                    ...
                                    w = parseInt(m[2]),
                                    b = parseInt(m[3]);
                                (a.dimension.height = b - v),
                                    (a.dimension.width = w - g),
                                    (a.offset.top = f + v),
                                    (a.offset.left = p + g);
                            } else if ("poly" == u) {
                                for (
                                ...
                                (a.dimension.height = k - C),
                                    (a.dimension.width = S - x),
                                    (a.offset.top = f + C),
                                    (a.offset.left = p + x);
                            } else
                        ...
                        if ("top" == M) {
                            var Q =
                                a.offset.left +
                                l -
                                (a.offset.left + a.dimension.width);
                            (A = a.offset.left + D - Q / 2),
                                (_ = a.offset.top - c - I - 12),
                                i(),
                                n("bottom", "top");
                        }
                        if (
                            ...
                            "top-right" == M &&
                                ((A =
                                    a.offset.left + a.dimension.width + D - l),
                                (_ = a.offset.top - c - I - 12),
                                i(),
                            ...
                            var Q =
                                ...
                                l -
                                (a.offset.left + a.dimension.width);
                            (A = a.offset.left - Q / 2 + D),
                                (_ =
                                    a.offset.top + a.dimension.height + I + 12),
                                i(),
                                n("top", "bottom");
                        }
                        if (
                            ...
                            (A = a.offset.left - D - l - 12),
                                (T =
                                    a.offset.left + D + a.dimension.width + 12);
                            var L =
                                a.offset.top +
                                c -
                                (a.offset.top + a.dimension.height);
                            if (
                                ((_ = a.offset.top - L / 2 - I),
                                A < 0 && T + l > s)
                            ) {
                                var F =
                                        2 *
                                        parseFloat(
                                            o.$tooltip.css("border-width")
                                        ),
                                    z = l + A - F;
                                o.$tooltip.css("width", z + "px"),
                                    (c = o.$tooltip.outerHeight(!1)),
                                    (A = a.offset.left - D - z - 12 - F),
                                    (L =
                                        a.offset.top +
                                        c -
                                        (a.offset.top + a.dimension.height)),
                        ...
                        if (o.options.arrow) {
                            ...
                            if (o.options.arrowColor.length < 1)
                                var $ = o.$tooltip.css("background-color");
                            else var $ = o.options.arrowColor;
                            if (
                                (r
                                    ? "left" == r
                                        ? ((O = "tooltipster-arrow-right"),
                                          (r = ""))
                                        : "right" == r
                                        ? ((O = "tooltipster-arrow-left"),
                                          (r = ""))
                                ...
                                var N = parseFloat(
                                        o.$tooltip.css("border-bottom-width")
                                    ),
                                ...
                                var N = parseFloat(
                                        o.$tooltip.css("border-top-width")
                                    ),
                                    W = o.$tooltip.css("border-top-color");
                            else if ("left" == M)
                                var N = parseFloat(
                                        o.$tooltip.css("border-right-width")
                                    ),
                                    W = o.$tooltip.css("border-right-color");
                            else if ("right" == M)
                                var N = parseFloat(
                                        o.$tooltip.css("border-left-width")
                                    ),
                ...
                elementIcon: function () {
                    return this.$el[0] !== this.$elProxy[0]
                        ? this.$elProxy[0]
                        : void 0;
                },
    ...
    function (t, e, i) {
        ...
        var n = i(28),
            ...
            O = function (t, e, i) {
                return i && r(D, e)
                    ? (i.enumerable
                          ? (r(t, T) && t[T][e] && (t[T][e] = !1),
                            (i = S(i, { enumerable: b(0, !1) })))
                          : (r(t, T) || C(t, T, b(1, {})), (t[T][e] = !0)),
                      L(t, e, i))
                    : C(t, e, i);
            },
            $ = function (t, e) {
                y(t);
                for (var i, n = g((e = w(e))), o = 0, r = n.length; r > o; )
                    O(t, (i = n[o++]), e[i]);
                return t;
            },
            N = function (t, e) {
            ...
            B = function (t) {
                for (var e, i = k(w(t)), n = [], o = 0; i.length > o; )
                    r(D, (e = i[o++])) || e == T || n.push(e);
                return n;
            },
            V = function (t) {
                for (var e, i = k(w(t)), n = [], o = 0; i.length > o; )
                    r(D, (e = i[o++])) && n.push(D[e]);
                return n;
            },
            R = function (t) {
                if (void 0 !== t && !z(t)) {
                    for (
                        var e, i, n = [t], o = 1, r = arguments;
                        r.length > o;
        ...
        M ||
            ...
            (n.getNames = m.get = B),
            (n.getSymbols = V),
            s && !i(54) && l(Q, "propertyIsEnumerable", W, !0));
        var U = {
            for: function (t) {
        ...
        n.each.call(
            ...
            P && a(a.S + a.F * (!M || q), "JSON", { stringify: R }),
            d(E, "Symbol"),
            d(Math, "Math", !0),
            d(o.JSON, "JSON", !0);
    },
    ...
    function (t, e, i) {
        ...
        t.exports = function (t, e) {
            for (
                var i, r = o(t), s = n.getKeys(r), a = s.length, l = 0;
                a > l;

            )
                if (r[(i = s[l++])] === e) return i;
        };
    },
    function (t, e, i) {
        var n = i(46),
    ...
    function (t, e, i) {
        ...
        t.exports = function (t) {
            var e = n.getKeys(t),
                i = n.getSymbols;
            if (i)
                for (var o, r = i(t), s = n.isEnum, a = 0; r.length > a; )
                    s.call(t, (o = r[a++])) && e.push(o);
            return e;
        };
    },
    function (t, e, i) {
    ...
    function (t, e) {
        ...
        function s(t) {
            var e = t.element,
                ...
                y = f + l() < r / 2,
                w = y ? l() : g,
                b = (r / 2 - Math.abs(g), Math.abs(w) / (r / 2)),
                x = 0;
        ...
        function c(t) {
            return (
                u(
                    t,
                    t.dataset.parallaxContainer || "[data-parallax-container]"
                ) || t
            );
        }
        function u(t) {
        ...
        Flatsome.plugin("resizeselect", function (t, e) {
            ...
            n.change(function () {
                var t = jQuery(this),
                    ...
                    n = jQuery("<span>").html(e);
                n.appendTo("body");
                var o = n.width();
                n.remove(),
                    t.width(o + i),
                    t.parent().parent().find("input.search-field").focus();
            }).change();
        });
    },
    function (t, e, i) {
        ...
        jQuery(
            ...
            jQuery('.mobile-sidebar a[href^="#"]').click(function () {
    ...
    function (t, e) {
        ...
        var i = function () {
            ...
            function e() {
                for (
                    var e = document.querySelectorAll("video"), n = -1;
                    e[++n];

                ) {
                    var o = t(e[n]);
                    (o["object-fit"] || o["object-position"]) &&
                        ((o["object-fit"] = o["object-fit"] || "fill"),
                        i(e[n], o));
                }
            }
            function i(t, e) {
    ...
    function (t, e, i) {
        ...
        !(function (r, s) {
            ...
            var n = function (t, e, i, n, o, r) {
                for (
                    var s = 0, a = ["webkit", "moz", "ms", "o"], l = 0;
                    l < a.length && !window.requestAnimationFrame;
                    ++l
                )
                    (window.requestAnimationFrame =
                        window[a[l] + "RequestAnimationFrame"]),
                        (window.cancelAnimationFrame =
                            window[a[l] + "CancelAnimationFrame"] ||
                            window[a[l] + "CancelRequestAnimationFrame"]);
                window.requestAnimationFrame ||
                    ...
                    (c.formatNumber = function (t) {
                        ...
                        if (
                            ...
                            for (; o.test(i); )
                                i = i.replace(
                                    o,
                                    "$1" + c.options.separator + "$2"
                                );
                        return c.options.prefix + i + n + c.options.suffix;
                    }),
                    (c.easeOutExpo = function (t, e, i, n) {
                        return (
                            (i * (-Math.pow(2, (-10 * t) / n) + 1) * 1024) /
                                1023 +
                            e
                        );
                    }),
                    (c.easingFn = c.options.easingFn
                        ? c.options.easingFn
                        : c.easeOutExpo),
                    (c.formattingFn = c.options.formattingFn
                            ...
                            c.countDown
                                ...
                                : (c.frameVal =
                                      c.frameVal > c.endVal
                                          ...
                                          : c.frameVal),
                            (c.frameVal =
                                Math.round(c.frameVal * c.dec) / c.dec),
                                ...
                                setTimeout(function () {
                                    jQuery.magnificPopup.open({
                                        ...
                                        items: {
                                            ...
                                            type: "inline",
                                            tLoading:
                                                '<div class="loading-spin dark"></div>',
                                        },
                                    });
                                }, r),
                                t.preventDefault();
        ...
        Flatsome.behavior("lightbox-video", {
            attach: function (t) {
                jQuery(
                    ...
                    callbacks: {
                        open: function () {
                            jQuery(".slider .is-selected .video").trigger(
                                "pause"
                            );
                        },
                        close: function () {
                        ...
                        if (
                            ...
                            i.on("cellSelect.flickity", function () {
                                i
                                    ...
                                    .trigger("pause"),
                                    i
                                        .find(".banner.is-selected .video-bg")
                                        .trigger("play");
                            }),
                ...
                e.length && (e.children().tooltipster("destroy"), e.remove()),
                    ...
                    t.length &&
                        ...
                        t.each(function (t, e) {
                            ...
                            if (
                                (jQuery("li.nav-single-page").before(u),
                                setTimeout(function () {
                                ...
                                n.waypoint(
                                    function (t) {
                                        jQuery(
                                            ".scroll-to-bullets a, .scroll-to-link"
                                        ).removeClass("active"),
                                            ...
                                            "up" === t &&
                                                jQuery(
                                                    ".scroll-to-bullets, .nav-single-page"
                                                )
                                                    .find(l)
                                                    .removeClass("active")
                                                    .prev()
                            ...
                            jQuery(this).next().is(":hidden")
                                ? (jQuery(this)
                                  ...
                                  /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(
                                      ...
                                      jQuery.scrollTo(jQuery(this), 300, {
                                          offset: -100,
                                      }))
                                : jQuery(this)
                                      .parent()
    ...
    function (t, e) {
        ...
        Flatsome.behavior("tooltips", {
            attach: function (t) {
                jQuery(
                    ".tooltip, .has-tooltip, .product-summary .star-rating, .tip-top, li.chosen a",
                    t
                ).tooltipster(),
