    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                    ...
                    <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">Ngô Quang linh</span><span
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user"><a href="{{route('admin.logout')}}"
                        class="dropdown-item" href="#"><i class="me-50" data-feather="power"></i> Đăng xuất</a>
                </div>
            </li>
        </ul>
    </div>
