        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body p-0">
                    ...
                    <form action="{{$service_detail->id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mt-1 mb-1">
                                            ...
                                            <input type="text" id="name" name="name" value="{{$service_detail->name}}" class="form-control" placeholder="Nhập tên">
                                            @error('name')
                                        ...
                                        <div class="form-group mt-1 mb-1">
                                            ...
                                            <input type="text" id="subname" name="subname" value="{{$service_detail->subname}}" class="form-control" placeholder="Nhập phụ đề">
                                            @error('subname')
                                            <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                            @enderror
                                        </div> 
                                        <div class="form-group mt-1 mb-1">
                                            ...
                                            <textarea class="form-control" id="summary-ckeditor" name="description">{{$service_detail->description}}</textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mt-1 mb-1">
                                                    <label for="inputName" class="form-label mb-1">Seo keyword:</label>
                                                    <input type="text" id="seo_keyword" name="seo_keyword" value="{{$service_detail->seo_keyword}}" class="form-control" placeholder="Nhập  từ khóa ">
                                                    @error('seo_keyword')
                                                    <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mt-1 mb-1">
                                                    ...
                                                    <input type="text" id="seo_description" name="seo_description" value="{{$service_detail->seo_description}}" class="form-control">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mt-1 mb-1">
                                                    ...
                                                    <input type="text" id="seo_title" name="seo_title" value="{{$service_detail->seo_title}}" class="form-control">
                                        ...
                                        <input type="hidden" name="image"  value="{{$service_detail->image}}">
                ...
                <div class="card-body">
                    <div id="imgList"
                        style="
                            ...
                            margin-bottom: 20px;
                        ">
                        <img style="width:100%; height:100%; border-radius:50%; object-fit:cover;" id="img_service" src="{{$service_detail->image}}"  alt="..">
                    </div>
        ...
        CKFinder.modal( {
            ...
            onInit: function( finder ) {
                finder.on( 'files:choose', function( evt ) {
                    ...
                    var img = document.getElementById('img_service')
