                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mt-1 mb-1">
                                            ...
                                            <input type="text" id="subname" name="subname" value="{{$blog_detail->subname}}" class="form-control" placeholder="Nhập phụ đề">
                                            @error('subname')
                                            <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                            @enderror
                                        </div> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mt-1 mb-1">
                                                    ...
                                                    <input type="text" id="seo_description" name="seo_description" value="{{$blog_detail->seo_description}}" class="form-control">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mt-1 mb-1">
                                                    ...
                                                    <input type="text" id="seo_title" name="seo_title" value="{{$blog_detail->seo_title}}" class="form-control">
