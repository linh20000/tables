                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <input type="number" id="percent_discount" name="percent_discount"  oninput="this.value = this.value.replace(/[^0-9.]/g, '')" min="0" max="100" value="{{$product->percent_discount}}" class="form-control" placeholder="Nhập phần trăm giảm giá ">
