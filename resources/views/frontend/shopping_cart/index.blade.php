                                                ...
                                                <tr class="woocommerce-cart-form__cart-item cart_item">
                                                    ...
                                                    <td class="product-quantity" data-title="Số lượng">
                                                        <div class="quantity buttons_added">
                                                            ...
                                                            <input type="number" class="input-text qty text" step="1" min="0" max="9999" name="cart[f016e59c7ad8b1d72903bb1aa5720d53][qty]" value="1" title="SL" size="4" pattern="[0-9]*" inputmode="numeric">
