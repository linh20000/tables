                                    ...
                                    <div class="icon-box-img" style="width: 60px">
                                        <div class="icon">
                                            <div class="icon-inner" style="color:rgb(0, 0, 0);">
                                                <img width="242" height="239" src="wp-content/uploads/2017/09/avatar.jpg" class="attachment-medium size-medium" alt="" />             
                                            </div>
                                        </div>
                                    </div>
                                    <div class="icon-box-text last-reset">
                                        <p>
                                            <span style="font-size: 85%;">Anh Thông, 38 tuổi, chúng tôi đã mua bộ bàn ghế thông minh của quý công ty và vẫn đang sử dụng , trong thời gian sử dụng chúng tôi chưa thấy vấn đề gì xảy ra .<br />Cảm ơn quý công ty đã cho tôi sử dụng bộ bàn ghế xếp thật gọn nhẹ ,đơn giản, tiết kiệm diện tích và đó tính thẩm Mỹ cao.&#8221;</span>
                                        </p>
                                    </div>
                                </div><!-- .icon-box -->
                            </div>
