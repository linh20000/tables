    ...
    >
        ...
        <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_1221083562">
            <div class="img-inner image-cover dark" style="padding-top:38.25%;">
                <img width="1920" height="745" src="{{$item->thumbnail}}" class="attachment-original size-original" alt="{{$item->name}}" srcset="{{$item->thumbnail}}" sizes="(max-width: 1920px) 100vw, 1920px" />                
            </div>
        </div>
        @endforeach
