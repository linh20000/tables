                 ...
                 <div class="col-inner text-center">
                     ...
                     <div class="row large-columns-4 medium-columns- small-columns-2 row-small slider row-slider slider-nav-reveal slider-nav-push"
                         ...
                         @foreach ($new_product as $item)
                             <div
                                 class="product-small col has-hover post-1428 product type-product status-publish has-post-thumbnail  last instock sale shipping-taxable purchasable product-type-simple">
                 ...
                 <div class="col-inner text-center">
                     ...
                     <div class="row large-columns-4 medium-columns- small-columns-2 row-small">
                         @foreach ($demo_product as $item)
                             <div
                                 class="product-small col has-hover post-1411 product type-product status-publish has-post-thumbnail  last instock shipping-taxable purchasable product-type-simple">
                                 @include('frontend.component.product_item')
                             </div><!-- col -->
                         @endforeach
                     </div>
