            ...
            <div class="flex-row recent-blog-posts align-top pt-half pb-half">
                        ...
                        <div class="badge-inner bg-fill"
                            style="
                              background: linear-gradient(
                                ...
                                url(../wp-content/uploads/2017/12/a-150x150.jpg);
                              color: #fff;
                ...
                <div class="flex-col flex-grow">
                    <a href="../cac-benh-hoc-duong-thuong-gap-cha-me-da-biet-chua/index.html"
                        title="CÁC BỆNH HỌC ĐƯỜNG THƯỜNG GẶP – CHA MẸ ĐÃ BIẾT CHƯA?">CÁC BỆNH HỌC ĐƯỜNG THƯỜNG GẶP – CHA
                        MẸ ĐÃ BIẾT
                        CHƯA?</a>
                    <span class="post_comments oppercase op-7 block is-xsmall"><a
                            href="../cac-benh-hoc-duong-thuong-gap-cha-me-da-biet-chua/index.html#respond"></a></span>
                </div>
            </div>
            <!-- .flex-row -->
        </li>
